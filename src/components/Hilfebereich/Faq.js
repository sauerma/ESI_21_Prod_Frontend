    ...
    const data = {
        ...
        rows: [
          ...
          },
          {
            ...
            content: "Im Bereich des Materialmanagements stehen unter „Aktuellem Bestand“ die bestellten Gesamtmengen sowie der Restwerte. Der Restwert pro Materialbestellung kann manuell bearbeitet werden und sollte nach jeder Schicht aktualisiert werden, um eine optimale Übersicht der aktuell in der Produktion befindlichen Rohmaterialien zu haben."
          },
          {
            title: "Wie gelange ich zu den Bereichen Materialwirtschaft und Vertrieb / Versand?",
            content: "In der Seitenleiste befindet sich das YourShirt Logo, über dieses kommt man direkt zur Übersichtsseite. Dort kann in die jeweiligen Bereiche abgesprungen werden, falls die Berechtigung dazu vorhanden ist."
          },
        ]
      }
